...
class CyberEmpVacation extends StatefulWidget {
  CyberEmpVacation({this.appBarTitle});
  final String appBarTitle;
  @override
  _CyberEmpVacationState createState() => _CyberEmpVacationState();
}

class _CyberEmpVacationState extends State<CyberEmpVacation> {
  String empName;
  //---------------------------------------------------
