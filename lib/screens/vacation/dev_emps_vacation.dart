...
class DevEmpVacation extends StatefulWidget {
  DevEmpVacation({this.appBarTitle});
  final String appBarTitle;
  @override
  _DevEmpVacationState createState() => _DevEmpVacationState();
}

class _DevEmpVacationState extends State<DevEmpVacation> {
  String empName;
  //---------------------------------------------------
  ...
  validate(String val) {
    if (val.isEmpty) {
      return 'من فضلك أدخل اسم الموظف';
    }
  }
